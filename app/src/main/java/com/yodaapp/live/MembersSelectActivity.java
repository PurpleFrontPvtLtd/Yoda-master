...
*/
                ...
                if (spnr_members.getSelectedItem().toString().contains("Select")){
               ...
               else if (spnr_members.getSelectedItem().toString().contains("School Group")){
                    scopeId="1";
                    sp_branch.setVisibility(View.GONE);
                    sp_grade.setVisibility(View.GONE);
                    sp_section.setVisibility(View.GONE);
...
//                Log.d("myaray2", myarray2_branch.get(position));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spnr_members.getSelectedItem().toString().contains("Select")){
                    Toast.makeText(thisActivity,getResources().getString(R.string.select_group_type),Toast.LENGTH_SHORT).show();

                }
                  else if (group_type.contains("School Group")){
        ...
        StringRequest request = new StringRequest(Request.Method.POST,getResources().getString(R.string.url_reference)+"home/individuals_contacts_list.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        listAdapter = new DisplayAdapter2(thisActivity,groupFeedlist,scopeId);
...
//                Log.d("school_id",school_id);
    ...
    public void onBack(){
        Intent intent=new Intent(MembersSelectActivity.this,CreateGroupActivity.class);
        startActivity(intent);
        finish();
