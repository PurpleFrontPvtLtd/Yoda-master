...
public class Section_Students_Assigned extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.section_students_assigned, container, false);
        ...
        ll = (LinearLayout) rootView.findViewById(R.id.section_students_assigned_layout);
        ...
        Button b = (Button) rootView.findViewById(R.id.section_student_assigned_submit);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, uri,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        progress.hide();
                      Log.d("student_response", response);
                        ...
                        if (feedslist2 != null) {
                            for (final Createadmin flower : feedslist2) {
                                if (flower.getSucess().equals("success") || flower.getSucess().equals("existing")) {
                                   ...
                                   Toast.makeText(getActivity(), "Already student assigned to this section", Toast.LENGTH_LONG).show();
                               }
                            }
                        }
//                        Log.d("here in sucess", "sucess");
