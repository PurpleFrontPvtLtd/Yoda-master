...
public class Grade_Creation extends Activity {
...
/*
       ...
       */     getActionBar().setIcon(drawable);
        ...
        progress = new ProgressDialog(Grade_Creation.this);
        ...
        try {
            ...
            old_staff_id = getIntent().getExtras().getString("grade_head_id");
            ...
            grade_head_id = getIntent().getExtras().getString("grade_head_id");



            if(redirection.equals("edit_grade_section"))
            {
                getActionBar().setTitle("Edit Grade");

                et.setText(grade_name);
...
//        Log.d("branch_name", branch_name);
        ...
        ArrayAdapter<String> adapter3 = new ArrayAdapter<>(Grade_Creation.this, android.R.layout.simple_spinner_dropdown_item, myarray);
...
//                Log.d("myaray2", myarray2.get(position));
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideKeyboard(Grade_Creation.this);

                grade_name = et.getText().toString();
                if (grade_name.equals("")) {
                    Toast.makeText(Grade_Creation.this, "Select Grade Name", Toast.LENGTH_SHORT).show();

                }

                else if (grade_head_name.equals("Select")){
                    Toast.makeText(Grade_Creation.this, "Select Grade Head", Toast.LENGTH_LONG).show();
                    ...
                    if (isonline()) {
                        ...
                        Toast.makeText(Grade_Creation.this, R.string.nointernetconnection, Toast.LENGTH_LONG).show();
                    }
...
//                        Log.d("error", "" + arg0.getMessage());
                        Toast.makeText(Grade_Creation.this, R.string.nointernetaccess, Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Grade_Creation.this, SplashScreen.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("school_id", school_id);
                        intent.putExtra("email", user_email);
                        Grade_Creation.this.finish();
                        finish();
                        ...
                        if (feedslist != null) {
                            for (final Createadmin flower : feedslist) {
                                if (flower.getSucess().equals("success")) {
                                    Intent intent = new Intent(Grade_Creation.this, Grade_Detail_View.class);
                                    ...
                                    Toast.makeText(Grade_Creation.this, getResources().getString(R.string.grade_name_exists), Toast.LENGTH_LONG).show();
                                }
//                                else {
...
//                        Toast.makeText(Grade_Creation.this, arg0.getMessage(), Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Grade_Creation.this, MainActivity.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("school_id", school_id);
                        intent.putExtra("email", user_email);
                        Grade_Creation.this.finish();
            ...
            protected Map<String, String> getParams() {
                ...
                Log.d("school_id", StaticVariable.school_id);
                Log.d("user_id", user_id);
                Log.d("head_id", grade_head_id);
...
//                        Log.d("response", arg0);
                        ...
                        if (feedslist != null) {
                            for (final Createadmin flower : feedslist) {
                                if (flower.getSucess().equals("success")) {
                                    Intent intent = new Intent(Grade_Creation.this, Branch_Detail_View.class);
                                    intent.putExtra("branch_id", branch_id);
                                    intent.putExtra("user_id", user_id);
                                    intent.putExtra("school_id", school_id);
                                    intent.putExtra("email", user_email);
