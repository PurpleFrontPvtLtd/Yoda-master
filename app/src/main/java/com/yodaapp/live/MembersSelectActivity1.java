...
import com.yodaapp.live.parsers.IndividualContactsListParser;
...
public class MembersSelectActivity1 extends Activity implements
    ...
    String branchId="",gradeId="",sectionId="";

    String staff_branch,staff_section,staff_grade,groupName,scopeId;
...
//
//                Toast.makeText(MembersSelectActivity.this, "close", Toast.LENGTH_SHORT).show();
...
//                Log.d("myaray2", myarray2_branch.get(position));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (group_type.contains("School Level")){
                ...
                else if (group_type.contains("Grade Level")){
                ...
                else if (group_type.contains("Branch Level")){
                      if (branch_type.equals("")||branch_type.equals("Select")) {
                        Toast.makeText(thisActivity,"Please select branch",Toast.LENGTH_SHORT).show();
                ...
                else if (group_type.contains("Section Level")){
                    if (branch_type.equals("")||branch_type.equals("Select")) {
                        Toast.makeText(thisActivity,"Please select branch",Toast.LENGTH_SHORT).show();
                ...
                else if (group_type.contains("Individuals Level")){
        ...
        StringRequest request = new StringRequest(Request.Method.POST,getResources().getString(R.string.url_reference)+"home/individuals_contacts_list.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        listAdapter = new DisplayAdapter2(thisActivity, groupFeedlist);
                        listview.setAdapter(listAdapter);

                        //search_view.setOnQueryTextListener(MembersSelectActivity.this);
...
//                        Log.d("error", "" + arg0.getMessage());
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("individual_level", adhoc_group);
...
//                Log.d("school_id",school_id);
    ...
    public void onBack(){
        Intent intent=new Intent(MembersSelectActivity1.this,CreateGroupActivity.class);
        startActivity(intent);
        finish();
    }
