...
public class Communication_Parents_Individual_Send extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.communication_parents_individual_send);
       ...
       getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        ...
        progress = new ProgressDialog(Communication_Parents_Individual_Send.this);
...
//            e.printStackTrace();
        ...
        if (school_id.equals("") || user_id.equals("")) {
            Toast.makeText(Communication_Parents_Individual_Send.this, getResources().getString(R.string.unknownerror3), Toast.LENGTH_LONG).show();
        } else {
            if (isonline()) {
                progress.show();
                updatedata(getResources().getString(R.string.url_reference) + "parent_home/individual_messages_parent_teacher.php");
            } else {
                Toast.makeText(Communication_Parents_Individual_Send.this, getResources().getString(R.string.nointernetconnection), Toast.LENGTH_LONG).show();
            }
        }
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if (!message.trim().equals("")) {
                        progress.show();
                        hideSoftKeyboard(Communication_Parents_Individual_Send.this);
                        ...
                        Toast.makeText(Communication_Parents_Individual_Send.this, getResources().getString(R.string.insert_message_sending), Toast.LENGTH_LONG).show();
                    }
                        ...
                        if (feedslist22 != null) {
                            for (final Createadmin flower : feedslist22) {
                                if (flower.getSucess().equals("success") && !flower.getId().equals("0")) {
                                    EditText et = (EditText) findViewById(R.id.communcations_parents_individual_send_message);
                                    et.setText("");
                                    AlertDialog.Builder builder = new AlertDialog.Builder(Communication_Parents_Individual_Send.this);
...
//                        Log.d("here in sucess", "sucess");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError arg0) {
                        progress.hide();
                        Toast.makeText(Communication_Parents_Individual_Send.this, R.string.nointernetaccess, Toast.LENGTH_LONG).show();
                        ...
                        builder.setMessage(getResources().getString(R.string.error_occured))
                                ...
                                .setPositiveButton(getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent(Communication_Parents_Individual_Send.this, SplashScreen.class);
                                        Communication_Parents_Individual_Send.this.finish();
                                        startActivity(intent);
                                        Communication_Parents_Individual_Send.this.overridePendingTransition(R.anim.left_to_right, R.anim.right_to_left);
                                    }
                                });
                        AlertDialog alert = builder.create();
                        alert.show();
    ...
    void updatedisplay() {
        ...
        if (feedslist != null) {
            ...
            for (final Communication_Parents_Individual_Send_Model flower : feedslist) {
                ...
                LinearLayout ll = new LinearLayout(Communication_Parents_Individual_Send.this);
                ...
                TextView tv = new TextView(Communication_Parents_Individual_Send.this);
                tv.setText(message_send_by);
                tv.setTextAppearance(Communication_Parents_Individual_Send.this, R.style.TextviewStyle);
                tv.setPadding(7,0,7,0);
                ll.addView(tv);

                TextView tv2 = new TextView(Communication_Parents_Individual_Send.this);
                tv2.setText(message_message);
                tv2.setTextAppearance(Communication_Parents_Individual_Send.this, R.style.SimpleTextviewStyle);
                tv2.setPadding(7, 0, 7, 0);
                ll.addView(tv2);

                TextView tv3 = new TextView(Communication_Parents_Individual_Send.this);
                tv3.setText(message_created);
                tv3.setLayoutParams(p3);
                tv3.setTextAppearance(Communication_Parents_Individual_Send.this, R.style.SimpleTextviewStyle_12);
                tv3.setPadding(7, 0, 7, 0);
                ll.addView(tv3);

                ImageView divider2 = new ImageView(Communication_Parents_Individual_Send.this);
            ...
            Toast.makeText(Communication_Parents_Individual_Send.this,getResources().getString(R.string.unknownerror7),Toast.LENGTH_LONG).show();
        }
        progress.hide();
    }
...
//                Log.d("teacher_id", teacher_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(Communication_Parents_Individual_Send.this, MainActivity_Parent.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Communication_Parents_Individual_Send.this, Communication_Parents_Staff_View.class);
        ...
        Communication_Parents_Individual_Send.this.finish();
        startActivity(intent);
        Communication_Parents_Individual_Send.this.overridePendingTransition(R.anim.left_right, R.anim.right_left);
    }
}
