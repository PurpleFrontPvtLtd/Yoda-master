...
import com.yodaapp.live.Groupinfo;
...
public class MessageViewSent extends Activity {
    ...
    String branch_id = "",group_id,group_name,scopeid="0";
    String branch_name = "";
    TextView tv;
...
/*
       ...
       */     getActionBar().setIcon(drawable);
        ...
        try {
            ...
            scopeid = getIntent().getExtras().getString("scopeid");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.create_group:
                ...
                Intent intent=new Intent(thisActivity, com.yodaapp.live.Parent.Groupinfo.class);
                startActivity(intent);
