...
public class StaffSendSchoolAdapter extends RecyclerView.Adapter<StaffSendSchoolAdapter.MyViewHolder> {
	List<Communicatioin_Staff_Send_School_Model> persons;
	String date,contact,message_created,name,chatData;
	Context context;
	Integer cbPos=0,selctedPos=0;


	public StaffSendSchoolAdapter(List<Communicatioin_Staff_Send_School_Model> persons, Context context) {
	...
	public void onBindViewHolder(final MyViewHolder holder, final int position) {
		...
		name=persons.get(position).getSend_by();
