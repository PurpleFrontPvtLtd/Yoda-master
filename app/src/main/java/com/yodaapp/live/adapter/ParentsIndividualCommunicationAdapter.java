 ...
 */
public class ParentsIndividualCommunicationAdapter extends BaseAdapter{

	private Context context;
	private LayoutInflater layoutInflater;
	private int count;
	private ArrayAdapter<String> adapter;
	List<Communication_Parents_Staff_View_Model> person;
	ArrayList<String> editQuantityList = new ArrayList<>();
	ArrayList<String> editQuantityList1 = new ArrayList<>();
	public ParentsIndividualCommunicationAdapter(Context context, List<Communication_Parents_Staff_View_Model> person) {
