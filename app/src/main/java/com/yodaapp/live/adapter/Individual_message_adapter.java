 ...
 */
public class Individual_message_adapter extends BaseAdapter{

	private Context context;
	private LayoutInflater layoutInflater;
	private int count;
	private ArrayAdapter<String> adapter;
	List<Communication_Staff_Message_Home_Model> person;
	ArrayList<String> editQuantityList = new ArrayList<>();
	ArrayList<String> editQuantityList1 = new ArrayList<>();
	public Individual_message_adapter(Context context, List<Communication_Staff_Message_Home_Model> person) {
