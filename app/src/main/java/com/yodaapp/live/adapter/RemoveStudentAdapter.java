...
public class RemoveStudentAdapter extends BaseAdapter {
	...
	public RemoveStudentAdapter(Context c, List<Group_Model> database_existing) {

		this.mContext = c;
		this.database_existing = database_existing;
	}

	public RemoveStudentAdapter(Context c, List<Group_Model> database_existing, String from)
	{
		this.mContext = c;
		this.database_existing = database_existing;
		this.from = from;
