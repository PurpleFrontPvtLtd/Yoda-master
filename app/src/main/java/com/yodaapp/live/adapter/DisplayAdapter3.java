...
public class DisplayAdapter3 extends BaseAdapter implements Filterable {
	...
	public DisplayAdapter3(Context c, List<Group_Model1>database_existing) {
	...
	public DisplayAdapter3(Context c, List<Group_Model1> database_existing, String from)
	{
		this.mContext = c;
		this.database_existing = database_existing;
		mStringFilterList = database_existing;
			...
			if (from.equals("9")){
				...
				mHolder.layout.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						Intent intent=new Intent(activity, com.yodaapp.live.Parent.MessageViewSentOneToOne.class);
