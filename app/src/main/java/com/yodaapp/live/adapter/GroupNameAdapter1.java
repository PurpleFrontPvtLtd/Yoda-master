 ...
 */
public class GroupNameAdapter1 extends BaseAdapter {
    ...
    public GroupNameAdapter1(Context c, ArrayList<String> gname, ArrayList<String> gid, ArrayList<String> unread) {
        this.mContext = c;
        this.gname = gname;
        this.gid = gid;
        this.unread = unread;
    ...
    public GroupNameAdapter1(Context c, List<MessageGroupDetails_Model> persons) {
        this.mContext = c;
    ...
    public View getView(int pos, View child, ViewGroup parent) {
        ...
        if (level.equals("1")) {
            ...
            mHolder.txt_phoneNumber.setText("Branch level-"+ StaticVariable.branch_list1.get(pos));
        }
        else if (level.equals("3")){
            mHolder.txt_phoneNumber.setVisibility(View.VISIBLE);

            mHolder.txt_phoneNumber.setText("Grade level-"+StaticVariable.grade_list1.get(pos));
        }
        else if (level.equals("4")){
            mHolder.txt_phoneNumber.setVisibility(View.VISIBLE);

            mHolder.txt_phoneNumber.setText("Section level-"+StaticVariable.section_list1.get(pos));
