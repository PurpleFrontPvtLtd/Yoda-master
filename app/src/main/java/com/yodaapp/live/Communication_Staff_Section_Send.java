...
public class Communication_Staff_Section_Send extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.communication_staff_section_send);
        ...
        progress = new ProgressDialog(Communication_Staff_Section_Send.this);
        ...
        ss = (ScrollView) findViewById(R.id.communication_staff_section_layout);
        ...
        try {
            TextView tv2 = (TextView) findViewById(R.id.section_communication_messages);
            tv2.setText(section_name + " " + getResources().getString(R.string.communications));
        } catch(Exception e) {
            e.printStackTrace();
        }

        TextView tv = (TextView) findViewById(R.id.communcations_staff_section_school_name);
        tv.setText(school_name);

        if (school_id.equals("") || user_id.equals("")) {
            Toast.makeText(Communication_Staff_Section_Send.this, getResources().getString(R.string.unknownerror3), Toast.LENGTH_LONG).show();
        } else {
            if (isonline()) {
                progress.show();
                updatedata(getResources().getString(R.string.url_reference) + "home/communication_recieve_section.php");
            } else {
                Toast.makeText(Communication_Staff_Section_Send.this, getResources().getString(R.string.nointernetconnection), Toast.LENGTH_LONG).show();
            }
        }

        Button b = (Button) findViewById(R.id.communication_staff_section_send_message_submit);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int cont = Integer.valueOf(role_id);
                if (cont < 6) {
                    EditText et = (EditText) findViewById(R.id.communication_staff_section_send_message);
                    String message = et.getText().toString();
                    if (!message.trim().equals("")) {
                        progress.show();
                        hideSoftKeyboard(Communication_Staff_Section_Send.this);
                        senddata(getResources().getString(R.string.url_reference) + "home/communication_send_section.php", message);
                    } else {
                        et.setError(getResources().getString(R.string.insert_message_sending));
                        Toast.makeText(Communication_Staff_Section_Send.this, getResources().getString(R.string.insert_message_sending), Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(Communication_Staff_Section_Send.this, getResources().getString(R.string.permission_error), Toast.LENGTH_LONG).show();
                }
            }
        });
                        ...
                        if (feedslist != null) {
                            for (final Createadmin flower : feedslist22) {
                                if (flower.getSucess().equals("success") && !flower.getId().equals("0")) {
                                    EditText et = (EditText) findViewById(R.id.communication_staff_section_send_message);
                                    et.setText("");
                                    AlertDialog.Builder builder = new AlertDialog.Builder(Communication_Staff_Section_Send.this);
                                    ...
                                    Toast.makeText(Communication_Staff_Section_Send.this, "Insert id - " + flower.getId(), Toast.LENGTH_LONG).show();
                                }
                            }
                        }
//                        Log.d("here in sucess", "sucess");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError arg0) {
                        progress.hide();
                        Toast.makeText(Communication_Staff_Section_Send.this, R.string.nointernetaccess, Toast.LENGTH_LONG).show();
//                        Toast.makeText(Communication_Staff_Section_Send.this, arg0.getMessage(), Toast.LENGTH_LONG).show();
//                        Log.d("here in error", arg0.getMessage());
                        ...
                        builder.setMessage(getResources().getString(R.string.error_occured))
                                ...
                                .setPositiveButton(getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent(Communication_Staff_Section_Send.this, SplashScreen.class);
                                        Communication_Staff_Section_Send.this.finish();
                                        startActivity(intent);
                                        Communication_Staff_Section_Send.this.overridePendingTransition(R.anim.left_to_right, R.anim.right_to_left);
                                    }
                                });
                        AlertDialog alert = builder.create();
                        alert.show();
...
//                Log.d("school_id", school_id);
    ...
    void updatedisplay() {
        progress.show();
        if (feedslist != null) {
            LinearLayout ll_main = (LinearLayout) findViewById(R.id.communication_staff_section_layout_linear);
            ...
            for (final Communicatioin_Staff_Send_School_Model flower : feedslist) {
                ...
                LinearLayout ll = new LinearLayout(Communication_Staff_Section_Send.this);
                ...
                TextView tv = new TextView(Communication_Staff_Section_Send.this);
                tv.setText(message_send_by);
                tv.setTextAppearance(Communication_Staff_Section_Send.this, R.style.TextviewStyle);
                tv.setPadding(7, 0, 7, 0);
                ll.addView(tv);

                TextView tv2 = new TextView(Communication_Staff_Section_Send.this);
                tv2.setText(message_message);
                tv2.setTextAppearance(Communication_Staff_Section_Send.this, R.style.SimpleTextviewStyle);
                tv2.setPadding(7, 0, 7, 0);
                ll.addView(tv2);

                if (!flower.getAttachment_id().equals("")) {
                    TextView tv4 = new TextView(Communication_Staff_Section_Send.this);
                    tv4.setText("Download File - " + flower.getFile_name() + "." + flower.getAttachment_type());
                    tv4.setTextAppearance(Communication_Staff_Section_Send.this, R.style.SimpleTextviewStyle);
                ...
                TextView tv3 = new TextView(Communication_Staff_Section_Send.this);
                tv3.setText(message_created);
                tv3.setLayoutParams(p3);
                tv3.setTextAppearance(Communication_Staff_Section_Send.this, R.style.SimpleTextviewStyle_12);
                tv3.setPadding(7, 0, 7, 0);
                ll.addView(tv3);

                ImageView divider2 = new ImageView(Communication_Staff_Section_Send.this);
            ...
            Toast.makeText(Communication_Staff_Section_Send.this, "No Response from server", Toast.LENGTH_LONG).show();
        }
        progress.hide();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.upload_menu_click: {
                Intent intent = new Intent(Communication_Staff_Section_Send.this, Upload_Image.class);
                intent.putExtra("school_id", school_id);
                intent.putExtra("user_id", user_id);
                intent.putExtra("email", user_email);
                intent.putExtra("school_name", school_name);
                intent.putExtra("role_id", role_id);
                intent.putExtra("direction", "section");
           ...
           /* case R.id.upload_menu_server_attach: {
            ...
            case android.R.id.home:
                Intent intent = new Intent(Communication_Staff_Section_Send.this, MainActivity.class);
                intent.putExtra("school_id", school_id);
                intent.putExtra("user_id", user_id);
                intent.putExtra("email", user_email);
...
//                            JSONObject obj = arr.getJSONObject(kk);
                ...
                ListView tv2 = new ListView(Communication_Staff_Section_Send.this);
                ArrayAdapter<String> modeAdapter = new ArrayAdapter<String>(Communication_Staff_Section_Send.this, android.R.layout.simple_list_item_1, android.R.id.text1, myarray2);
                ...
                tv2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        LinearLayout ll2 = new LinearLayout(Communication_Staff_Section_Send.this);
                        ll2.setOrientation(LinearLayout.VERTICAL);
                        final EditText et = new EditText(Communication_Staff_Section_Send.this);
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (cont < 4) {
                                            ...
                                            if (!message.trim().equals("")) {
                                                progress.show();
                                                hideSoftKeyboard(Communication_Staff_Section_Send.this);
                                                senddata(getResources().getString(R.string.url_reference) + "home/communication_recieve_section.php", message);
                                            } else {
                                                Toast.makeText(Communication_Staff_Section_Send.this, getResources().getString(R.string.insert_message_sending), Toast.LENGTH_LONG).show();
                                            }
                                        } else {
                        ...
                        Toast.makeText(Communication_Staff_Section_Send.this, attach_file + " is selected", Toast.LENGTH_LONG).show();
                    }
                });
            }
        }, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                progress.hide();
                Toast.makeText(Communication_Staff_Section_Send.this, R.string.nointernetaccess, Toast.LENGTH_LONG).show();
//                Toast.makeText(Communication_Staff_Section_Send.this, volleyError.getMessage(), Toast.LENGTH_LONG).show();
...
//                Log.d("school_id", school_id);
    ...
    public void onBackPressed() {
        ...
        if(ddefault != null) {
            if (ddefault.equals("ddefault")) {
                ...
                Intent intent = new Intent(Communication_Staff_Section_Send.this, Communication_Staff_Section.class);
                intent.putExtra("branch_id", branch_id);
                intent.putExtra("branch_name", branch_name);
                intent.putExtra("user_id", user_id);
                intent.putExtra("school_id", school_id);
                ...
                Communication_Staff_Section_Send.this.finish();
                startActivity(intent);
                Communication_Staff_Section_Send.this.overridePendingTransition(R.anim.left_right, R.anim.right_left);
            }
        }
        else {
            Intent intent = new Intent(Communication_Staff_Section_Send.this, Communication_Staff_Section.class);
    ...
    private class DownloadFile extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(Communication_Staff_Section_Send.this);
...
//                    e.printStackTrace();
//                    Toast.makeText(Communication_Staff_Section_Send.this, "No Application available to view file", Toast.LENGTH_SHORT).show();
//                }
                ...
                try {
                    ...
                    Toast.makeText(Communication_Staff_Section_Send.this, "No handler for this type of file.", Toast.LENGTH_LONG).show();
                }
